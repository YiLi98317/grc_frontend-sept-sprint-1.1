...
const AirCalender = (props) => {
    ...
    const fetchData = (ev, picker = null) => {
        ...
        if (type == 'daterange') {
            ...
            eDate = `${picker.startDate.format(dateFormat)}`
        } else {
            sDate = `${picker.startDate.format(dateFormat)}`
            eDate = null
        }
    ...
    const getInitialSettings = () => {
        ...
        setStartDate(calStDate)
        // myRef.current.setStartDate(calStDate)
